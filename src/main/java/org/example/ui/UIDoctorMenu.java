        ...
        private static void showAddAvailableAppointmentsMenu() {
            ...
            do {
                ...
                if(response > 0 && response < 4) {
                    ...
                    if (responseDate == 2) continue; // este continue vuelve a mostrar el if anterior ya que saltea el else y vuelve a entrar al dowhile

                    int responseTime = 0;
                    String time = "";
                    do {
                        System.out.println("Insert the available time for this date: " + date + " [16:00]");
                        time = sc.nextLine();
